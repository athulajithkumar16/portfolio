...
// Improved smooth parallax effect for hero section
let ticking = false;
let lastScrollY = 0;
...
// Add some random data visualization animations
...
// Initialize data point animations
document.addEventListener('DOMContentLoaded', () => {
    setTimeout(animateDataPoints, 2000);
});
