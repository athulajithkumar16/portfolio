...
const interactiveElements = document.querySelectorAll('a, button, input, textarea, select, .btn, .nav-link, .social-link, .project-card, .skill-item, .contact-item');
...
// Animate data points in project cards
function animateDataPoints() {
    const dataPoints = document.querySelectorAll('.data-points .point');
    dataPoints.forEach((point, index) => {
        point.style.animationDelay = `${index * 0.2}s`;
    });
}

// Initialize animations when projects section is visible
...
document.addEventListener('DOMContentLoaded', () => {
    // Add custom cursor element if it doesn't exist
